...
А точнее **НЕ ЧИТАЙТЕ! ОНО ТОГО НЕ СТОИТ!**:
```
...
Именно для этого я написал этот гайд, даже скорее руководство.
...
Полный список можете найти тут - https://ru.wikipedia.org/wiki/%D0%A1%D0%BF%D0%B8%D1%81%D0%BE%D0%BA_%D0%BF%D0%BE%D1%80%D1%82%D0%BE%D0%B2_TCP_%D0%B8_UDP
...
```
PS: Ссылки указывать нельзя! Только всё что я написал.
...
Но помните что использывание `-Pn`, `-n` понижает точность сканирования.
